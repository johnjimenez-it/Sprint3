...
5. **Payment Method**
   - Grid of payment cards (cash, check, debit, credit) filtered by config; selecting one reveals contextual instructions (e.g., “Insert card when prompted”).
...
- `payment_methods` list (subset of {cash, check, debit, credit, none}).
...
- If cash or check selected, instructions display: “Present payment to attendant now.”
